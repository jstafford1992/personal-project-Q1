...
function combineTypes() {
    if (moveData.type.name === "bug") {
        bugAttack();
    } else if (moveData.type.name === "dark") {
        darkAttack();
    } else if (moveData.type.name === "dragon") {
        dragonAttack();
    } else if (moveData.type.name === "electric") {
        electricAttack();
    } else if (moveData.type.name === "fairy") {
        fairyAttack();
    } else if (moveData.type.name === "fighting") {
        fightingAttack();
    } else if (moveData.type.name === "fire") {
        fireAttack();
    } else if (moveData.type.name === "flying") {
        flyingAttack();
    } else if (moveData.type.name === "ghost") {
        ghostAttack();
    } else if (moveData.type.name === "grass") {
        grassAttack();
    } else if (moveData.type.name === "ground") {
        groundAttack();
    } else if (moveData.type.name === "ice") {
        iceAttack();
    } else if (moveData.type.name === "normal") {
        normalAttack();
    } else if (moveData.type.name === "poison") {
        poisonAttack();
    } else if (moveData.type.name === "psychic") {
        psychicAttack();
    } else if (moveData.type.name === "rock") {
        rockAttack();
    } else if (moveData.type.name === "steel") {
        steelAttack();
    } else if (moveData.type.name === "water") {
        waterAttack();
    } else {
        console.log("I'm fucked, just royally fucked");
        console.log("I'm fucking dead. Seriously I fucking hate this by now.");
    }

}

///CURRENTLY THIS EFFECTS ALL ATTACKS NOT JUST ONES OF BUG TYPE
function bugAttack() {
    //does double damage to Psychic, Grass, and Dark pokemon types
    doubleDamageTo = ["psychic", "grass", "dark"];
    //does half (1/2) damage to Fight, Fire, Flying, Ghost, Poison, Steel, Fairy pokemon types
    halfDamageTo = ["fight", "fire", "flying", "ghost", "poison", "steel", "fairy"];
...
function electricAttack() {
    ...
    halfDamageTo = ["dragon", "electric", "grass"];
    noDamageTo = ["ground"];
    ifAttackType();
}

function fairyAttack() {
    doubleDamageTo = ["dark", "dragon", "fight"];
    halfDamageTo = ["fire", "poison", "steel"];
    ifAttackType();
}

function fightingAttack() {
    doubleDamageTo = ["dark", "ice", "normal", "rock", "steel"];
    halfDamageTo = ["bug", "fairy", "flying", "poison", "psychic"];
    noDamageTo = ["ghost"];
    ifAttackType();
}

function fireAttack() {
    doubleDamageTo = ["bug", "grass", "ice", "steel"];
    halfDamageTo = ["dragon", "fire", "rock", "water"];
    ifAttackType();
}

function flyingAttack() {
    doubleDamageTo = ["bug", "fight", "grass"];
...
function grassAttack() {
    ...
    halfDamageTo = ["bug", "dragon", "fire", "flying", "grass", "poison", "steel"];
    ifAttackType();
}

function groundAttack() {
    doubleDamageTo = ["electric", "fire", "poison", "rock", "steel"];
    halfDamageTo = ["bug", "grass"];
    ifAttackType();
}

function iceAttack() {
    doubleDamageTo = ["dragon", "flying", "grass", "ground"];
    halfDamageTo = ["fire", "ice", "steel", "water"];
    ifAttackType();
}
...
function poisonAttack() {
    ...
    halfDamageTo = ["ghost", "ground", "poison", "rock"];
    noDamageTo = ["steel"];
    ifAttackType();
}

function psychicAttack() {
    doubleDamageTo = ["fight", "poison"];
    halfDamageTo = ["psychic", "steel"];
    noDamageTo = ["dark"];
}

function rockAttack() {
    doubleDamageTo = ["bug", "fire", "flying", "ice"];
    halfDamageTo = ["fight", "ground", "steel"];
    ifAttackType();
}

function steelAttack() {
    doubleDamageTo = ["fairy", "ice", "rock"];
    halfDamageTo = ["electric", "fire", "steel", "water"];
    ifAttackType();
}

function waterAttack() {
    doubleDamageTo = ["fire", "ground", "rock"];
    halfDamageTo = ["dragon", "grass", "water"];
    ifAttackType();
}
